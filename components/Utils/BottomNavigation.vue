<template>
  <div class='m-14 w-full bg-base-200'>
    <div class='fixed inset-x-0 bottom-0 block bg-base-200 shadow-xl'>
      ...
      >
        ...
        <NuxtLink class='hoveranimation hover:cursor-pointer' @click='modalProfile=true'>
          <Icon-lucide-user
  ...
  <ModalProfile v-if='modalProfile' @closeModalProfile='closeModalProfile' @logout='logout' />
