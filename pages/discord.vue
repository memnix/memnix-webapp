    ...
    <div class='container mx-auto px-6 py-14'>
      <div class='my-12 max-w-xl'>
        ...
        <div class='flex items-center'>
          <NuxtLink href='https://discord.gg/de4hY4VEkJ'>
      ...
      >
        <UtilsFeatureBox icon='message' title='Meet our team'>
        ...
        <UtilsFeatureBox icon='crown' title='Unique benefits'>
          <p class='text-sm lg:text-lg'>
            Enjoy
            <a
              class='underline decoration-secondary decoration-2 lg:decoration-4'
        ...
        <UtilsFeatureBox icon='code' title='Contribute to the project'>
          <p class='text-sm lg:text-lg'>
            <a
              class='underline decoration-secondary decoration-2 lg:decoration-4'
            >Contribute</a
        ...
        <UtilsFeatureBox icon='users' title='A nice community'>
          <p class='text-sm lg:text-lg'>
