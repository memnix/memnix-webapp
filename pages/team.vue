          ...
          <div class="-m-4 flex flex-wrap">
            ...
            <div class="p-4 lg:w-1/2">
              ...
              >
                ...
                />
                <div class="flex-grow sm:pl-8">
                  <h2 class="text-lg font-medium">Alper Kamu</h2>
            ...
            <div class="p-4 lg:w-1/2">
              ...
              >
                ...
                />
                <div class="flex-grow sm:pl-8">
                  <h2 class="text-lg font-medium">Atticus Finch</h2>
                  <h3 class="mb-3">UI Developer</h3>
                  <p class="mb-4">
                    DIY tote bag drinking vinegar cronut adaptogen squid fanny
                    pack vaporware.
            ...
            <div class="p-4 lg:w-1/2">
              ...
              >
                ...
                />
                <div class="flex-grow sm:pl-8">
                  <h2 class="text-lg font-medium">Henry Letham</h2>
                  <h3 class="mb-3">Designer</h3>
                  <p class="mb-4">
                    DIY tote bag drinking vinegar cronut adaptogen squid fanny
                    pack vaporware.
    ...
    <div class="mx-auto px-5 py-24 bg-base-100">
      ...
      <div class="-m-2 flex flex-wrap">
        <div class="w-full p-2 md:w-1/2 lg:w-1/3">
          <div
            class="flex h-full items-center rounded-lg border border-gray-200 p-4"
          >
            <img
              alt="team"
            ...
            />
            <div class="flex-grow">
              <h2 class="title-font font-medium">Holden Caulfield</h2>
        ...
        <div class="w-full p-2 md:w-1/2 lg:w-1/3">
          ...
          >
            ...
            />
            <div class="flex-grow">
              <h2 class="title-font font-medium">Henry Letham</h2>
        ...
        <div class="w-full p-2 md:w-1/2 lg:w-1/3">
          ...
          >
            ...
            />
            <div class="flex-grow">
              <h2 class="title-font font-medium">Oskar Blinde</h2>
